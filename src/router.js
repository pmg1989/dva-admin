  ...
  return (
    <Router history={history}>
      <Route path="/" component={require('./routes/App')} onEnter={redirectToLogin}>
        ...
        <Route path="system">
          <Route path="modify-password" component={require('./routes/system/ModifyPassword')} />
        </Route>
        <Route path="bbs">
          <Route path="category" component={require('./routes/bbs/Category')} />
        </Route>
        <Route path="ui">
          <Route path="upload" component={require('./routes/ui/Upload')} />
          <Route path="media-player" component={require('./routes/ui/MediaPlayer')} />
          <Route path="drop-menu" component={require('./routes/ui/DropMenu')} />
